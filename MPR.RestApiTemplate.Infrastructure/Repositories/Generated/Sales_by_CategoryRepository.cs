...
{
    public partial class Sales_by_CategoryRepository(NorthwindContext northwindContext) : GenericRepository<Sales_by_Category>(northwindContext), ISales_by_CategoryRepository
    {
    }
}
