...
{
    public partial class CustomerDemographicRepository(NorthwindContext northwindContext) : GenericRepository<CustomerDemographic>(northwindContext), ICustomerDemographicRepository
    {
    }
}
