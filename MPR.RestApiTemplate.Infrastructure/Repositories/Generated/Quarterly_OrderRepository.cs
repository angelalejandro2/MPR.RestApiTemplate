...
{
    public partial class Quarterly_OrderRepository(NorthwindContext northwindContext) : GenericRepository<Quarterly_Order>(northwindContext), IQuarterly_OrderRepository
    {
    }
}
