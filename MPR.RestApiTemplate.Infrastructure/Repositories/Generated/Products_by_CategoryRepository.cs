...
{
    public partial class Products_by_CategoryRepository(NorthwindContext northwindContext) : GenericRepository<Products_by_Category>(northwindContext), IProducts_by_CategoryRepository
    {
    }
}
