...
{
    public partial class Order_SubtotalRepository(NorthwindContext northwindContext) : GenericRepository<Order_Subtotal>(northwindContext), IOrder_SubtotalRepository
    {
    }
}
